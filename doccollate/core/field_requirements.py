...
FIELD_DEPENDENCIES = {
    ...
    "tech__hardware_run": {"env__server_config", "env__client_config"},
    "tech__language": {"env__language"},
    "tech__main_functions": {"product__main_functions"},
    "tech__os_dev": {"env__os_version", "env__os", "env__server_os", "env__client_os"},
    "tech__os_run": {"env__server_os", "env__client_os"},
    "tech__run_support": {"env__server_soft", "env__client_soft"},
}
