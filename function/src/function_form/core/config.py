...
def load_config(path: str) -> AppConfig:
    ...
    function_template = _resolve_path(
        _read_env("DOCCOLLATE_TEMPLATE_FUNCTION") or str(templates.get("function", "")).strip(),
        base_dir,
    )

    return AppConfig(
        llm=llm_config,
        templates=TemplateConfig(function=function_template),
